<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/main.Master" AutoEventWireup="true" CodeBehind="frmCreateRoaster.aspx.cs" Inherits="Seguro.Accounts.frmCreateRoaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(function () {
            ...
            $("#<%= txtSearchEmployeeName.ClientID %>")
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Create/Manage Roster</h1>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtSearchEmployeeName" CssClass="form-control" placeholder="Type Employee's Name to search" runat="server" multiple="multiple"></asp:TextBox>
                            ...
                            <div class="col-lg-12">
                                ...
                                <asp:GridView ID="grdViewShifts" Width="100%" class="table table-striped table-bordered table-hover" AllowPaging="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="RosterDate" HeaderText="Date" DataFormatString="{0:dd/MMM/yyyy}" />
                                        <asp:BoundField DataField="RosterStartTime" HeaderText="Start Time" />
                                        <asp:BoundField DataField="RosterEndTime" HeaderText="End Time" />
