<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/main.Master" AutoEventWireup="true" CodeBehind="ViewSub-Contractor.aspx.cs" Inherits="Morpheus.Accounts.ViewSub_Contractor" %>
               ...
               <div class="col-lg-12">
                   <div class="panel panel-default">
                       ...
                       <div class="panel-body">
                           ...
                           <asp:GridView ID="dtgridview_SubContractor" Width="100%" class="table table-striped table-bordered table-hover"
                               runat="server" AutoGenerateColumns="False"
                               AutoGenerateSelectButton="True" OnSelectedIndexChanged="dtgridview_SubContractor_SelectedIndexChanged" OnSelectedIndexChanging="dtgridview_SubContractor_SelectedIndexChanging">
                               <Columns>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div style = " width: 95%;padding: 0px 0px 0px 20px; float:left;">
                                    ...
                                    <asp:Button ID="btnUpdateSubContractorDetails" type="submit" 
                                        class="btn btn-primary btn-lg btn-block" runat="server"
                                        Text="Update" onclick="btnUpdateSubContractorDetails_Click" />
