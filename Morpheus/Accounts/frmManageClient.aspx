<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/main.Master" AutoEventWireup="true" CodeBehind="frmManageClient.aspx.cs" Inherits="Morpheus.Accounts.frmManageClient" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Add/Update Client Name(s)</h1>
                                        ...
                                        <asp:GridView ID="gvMaster" runat="server" AutoGenerateColumns="False" GridLines="none"  class="table table-striped table-bordered table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:LinkButton runat="server" ID="lbEdit" Text="Edit" CausesValidation="false" CommandName="EditRow" CommandArgument='<%# Eval("clientId") %>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Delete">
                                                    <ItemTemplate>
                                                        <asp:LinkButton runat="server" ID="lbDelete" Text="Delete" CausesValidation="false" CommandName="DeleteClient" CommandArgument='<%# Eval("clientId") %>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                    ...
                    <div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        Add/Update Client Name
                                    </div>
                                    <div class="panel-body">
                                        <asp:Label ID="lblID" runat="server" Text="" Visible="false"></asp:Label>
                                        <div class="form-group">
                                            <label>Client Name:</label>
                                            <asp:TextBox class="form-control" ID="txtName" ToolTip="Enter Client Name"  runat="server"></asp:TextBox>
