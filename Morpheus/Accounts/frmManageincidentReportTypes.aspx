<%@ Page Title="" Language="C#" MasterPageFile="~/Accounts/main.Master" AutoEventWireup="true" CodeBehind="frmManageincidentReportTypes.aspx.cs" Inherits="Seguro.Accounts.frmManageincidentReportTypes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Manage Incident Report Types</h1>
                                    ...
                                    <div class="panel-body">
                                        <asp:GridView ID="gvMaster" runat="server" AutoGenerateColumns="False" GridLines="none"  class="table table-striped table-bordered table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="RptTpye" HeaderText="Type Name">
                                                </asp:BoundField>
                                                <asp:BoundField DataField="RptDescription" HeaderText="description">
                                                </asp:BoundField>
                                                <asp:BoundField DataField="type_name" HeaderText="CompanyType"/>
                                                <asp:TemplateField HeaderText="Edit">
                                                    <ItemTemplate>
                                                        <asp:LinkButton runat="server" ID="lbEdit" Text="Edit" CommandName="EditRow" CausesValidation="false" CommandArgument='<%# Eval("id") %>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Delete">
                                                    <ItemTemplate>
                                                        <asp:LinkButton runat="server" ID="lbDelete" Text="Delete" CausesValidation="false" CommandName="Delete" CommandArgument='<%# Eval("id") %>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
